...
class PostsListCaseStudy extends PostsList {
	constructor(el) {
		...
		this.formSearchEl = document.querySelector(
			'.banner-case-study-archive form#form_filter_search'
		);
		this.filterIndustryEl = document.querySelector(
			'.banner-case-study-archive select#filter_industry'
		);
		this.filterTagEl = document.querySelector('.banner-case-study-archive select#filter_tag');
